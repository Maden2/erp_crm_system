...
class NotificationItemCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // تحديد مسار الـ SVG وألوان الخلفية والأيقونة بناءً على نوع الإشعار
    String svgPath;
    Color iconColor;
    Color bgColor;
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          // 1️⃣ الأيقونة الدائرية الملونة يمين (باستخدام SVG المحدث)
          Container(
            width: 40.w,
            height: 40.w,
            padding: EdgeInsets.all(10.r), // Padding داخلي عشان حجم الـ SVG يكون متناسق
            decoration: BoxDecoration(
              color: bgColor,

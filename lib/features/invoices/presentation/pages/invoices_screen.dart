                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        _buildFilterChip(
                          label: "غير مدفوع",
                          isSelected: _selectedStatus == InvoiceStatus.unpaid,
                          onTap: () => setModalState(
                            () => _selectedStatus = InvoiceStatus.unpaid,
                          ),
                        ),
                        SizedBox(width: 8.w),
                        _buildFilterChip(
                          label: "ملغاة",
                          isSelected: _selectedStatus == InvoiceStatus.canceled,
                          onTap: () => setModalState(
                            () => _selectedStatus = InvoiceStatus.canceled,
                          ),
                        ),
                      ],
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        _buildFilterChip(
                          ...
                          onTap: () =>
                              setModalState(() => _selectedTimeFrame = "الكل"),
                        ),
                        SizedBox(width: 8.w),
                        _buildFilterChip(
                          label: "اليوم",
                          ...
                          onTap: () =>
                              setModalState(() => _selectedTimeFrame = "اليوم"),
                        ),
                        SizedBox(width: 8.w),
                        _buildFilterChip(
                          label: "هذا الشهر",
                          ...
                          onTap: () => setModalState(
                            () => _selectedTimeFrame = "هذا الشهر",
                          ),
                        ),
                        SizedBox(width: 8.w),
                        _buildFilterChip(
                          label: "مخصص",
                          isSelected: _selectedTimeFrame == "مخصص",
                          onTap: () =>
                              setModalState(() => _selectedTimeFrame = "مخصص"),
                        ),
                      ],
                    ),
                    SizedBox(height: 20.h),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        _buildFilterChip(
                          label: "بطاقة",
                          isSelected: _selectedPaymentMethod == "بطاقة",
                          onTap: () => setModalState(
                            () => _selectedPaymentMethod = "بطاقة",
                          ),
                        ),
                        SizedBox(width: 8.w),
                        _buildFilterChip(
                          label: "تحويل",
                          isSelected: _selectedPaymentMethod == "تحويل",
                          onTap: () => setModalState(
                            () => _selectedPaymentMethod = "تحويل",
                          ),
                        ),
                        SizedBox(width: 8.w),
                        _buildFilterChip(
                          label: "نقدي",
                          isSelected: _selectedPaymentMethod == "نقدي",
                          onTap: () => setModalState(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isSelected
                ? const Color(0xff0D256F).withAlpha(76)
      ...
      appBar: CustomAppBar(
        ...
        title: _isSearching
            ? TextField(
                ...
                onChanged: (query) {
                  context.read<InvoicesCubit>().searchInvoices(query);
                },
              )
            ...
            onPressed: () {
              setState(() {
                if (_isSearching) {
                  ...
                  context.read<InvoicesCubit>().searchInvoices("");
                } else {
                  _isSearching = true;
                }
              });
          ...
          if (state is InvoicesLoading) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                return InvoiceCardItem(invoice: state.filteredInvoices[index]);
              },
            );

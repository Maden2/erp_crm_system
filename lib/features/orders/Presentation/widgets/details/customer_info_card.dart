...
class CustomerInfoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _buildSectionCard("معلومات العميل", [
      ...
      _buildDetailRow(AppAssets.phoneIcon, "رقم الهاتف", order.customerPhone),
      _buildDetailRow(
        AppAssets.mailIcon,
        "البريد الإلكتروني",
        order.customerEmail,
      ),
      _buildDetailRow(AppAssets.mapIcon, "عنوان الشحن", order.shippingAddress),

      if (order.staffNotes.isNotEmpty) ...[
        SizedBox(height: 16.h),
        _buildNoteBox(order.staffNotes),
      ],
    ]);
  }
